...
df_results = pd.DataFrame(columns = ["Algorithm", "Data_Size", "Seed", "a_prime", "sigma_square", "alternative_proxy_eta_parameter", "ATT_Estimation", "kernelZ_length_scale", "Algo_Run_Time"])
            ...
            for a_prime in a_prime_list:
                for label_variance_in_eta_opt_ in label_variance_in_eta_opt_list:
                    for kernelZ_length_scale_ in kernelZ_length_scale_list:
                        ...
                        df_results.to_pickle("../Results/SyntheticData_ATT_Estimation_KernelZ_Bandwidth_Ablation.pkl")
