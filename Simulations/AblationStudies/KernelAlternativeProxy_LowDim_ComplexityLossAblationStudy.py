...
df_results = pd.DataFrame(columns = ["Algorithm", "Data_Size", "Seed", "Causal_MSE", "Causal_MAE", "eta_parameter", "sigma_square", "scale_data", "stage1_perc", "length_scale_heuristic_quantile", "Algo_Run_Time"])
            ...
            for scale_data in scale_data_list:
                for stage1_perc_ in stage1_perc_list:
                    for label_variance_in_eta_opt_ in label_variance_in_eta_opt_list:
                        ...
                        df_results.to_pickle("../Results/Kernel_Alternative_Proxy_Synthetic_Experiment1_ComplexityLoss_AblationStudy.pkl")